					...
					<div className='order' key={i} onClick={(e) => toggleShow(e)}>
						<div className='top'>
							<div className='details'>
								<p>#{order.id}</p>
								<p>{order.date}</p>
								<p>{order.data[2].value} {order.data[3].value}</p>
								<p>${order.data[0].value}</p>
							</div>
							<div className={'status ' + order.data[12].status} data-id={order.id} data-status={order.data[12].status} onClick={(e) => toggleStatus(e)}>
						...
						<div className='main'>
							<div className='person'>
								<p>Email: <span>{order.data[4].value}</span></p>
								<p>Phone: <span>{order.data[5].value}</span></p>
								<p>Address: <span>{order.data[6].value}</span></p>
								<p>City: <span>{order.data[7].value}</span></p>
								<p>State: <span>{order.data[8].value}</span></p>
								<p>Country: <span>{order.data[9].value}</span></p>
							</div>
							<div className='product'>
								{order.data[11] && order.data[11].items.map((item, j) => {
									return (
								...
								<p>Delivery Instructions: <span>{order.data[10].value}</span></p>
							</div>
						</div>
					</div>
				)
